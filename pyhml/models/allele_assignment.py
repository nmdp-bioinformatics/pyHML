...
class AlleleAssignment(Model):
    ...
    """
    def __init__(self, allele_db: str=None, allele_version: str=None, date: str=None, glstring: List[str]=None, haploid: Haploid=None):
        """
    ...
    @haploid.setter
    def haploid(self, haploid: Haploid):
        """
